            ...
            <div class="paragraphPart">
                <div class="flexPartLeft">
                    ...
                    <div class="sliderSectionBtnPart">
                        <a class="generalButton highMargined" href="#">دریافت نوبت</a>
                        <a class="generalButton outlineButton noBorderButton" href="#">دریافت نوبت</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="lightBoxBack highRadius highPadding commentBoxCard">
                    <div class="commentHeader">
                        ...
                        <div class="innerCommentHeader">
                            ...
                            <span class="cmSide smallText">متن ساختگی</span>
                        </div>
                    </div>
                    <p class="mainParagraph mediumMargined">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز</p>
